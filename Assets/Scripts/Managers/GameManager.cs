...
public class GameManager : MonoBehaviour
{
    ...
    void PrepareLevel(int levelIndex)
    {
        ...
        CurrentPlayer = Instantiate(playerPrefab, level.StartPosition.position + level.StartPosition.forward.normalized * 4, level.StartPosition.rotation);
        var player = CurrentPlayer.GetComponent<Player>();
        player.InitializePlayerHealth();
